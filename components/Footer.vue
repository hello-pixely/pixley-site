<template lang="html">
  <footer class="global">
    <p>
      &#169; <a href="https://pixely.com/">2020 PIXELY</a>.
      <!-- <span class="is-hidden-mobile">All Rights Reserved.</span> -->
    </p>
    <!-- <img
      src="~/static/powered_by_stripe.svg"
      alt="Powered by Stripe, Secure Checkout. Your data is securely handled by our partners"
    /> -->
    ...
    <svg
      ...
      y="0px"
      viewBox="0 0 149 41"
      style="enable-background:new 0 0 149 41;"
      xml:space="preserve"
    >
      <style type="text/css">
        .st0 {
      ...
      <path
        class="st0"
        d="M6,0h137c3.3,0,6,2.7,6,6v29c0,3.3-2.7,6-6,6H6c-3.3,0-6-2.7-6-6V6C0,2.7,2.7,0,6,0z"
      />
      <path
        class="st1"
        d="M71.4,26.6h-1.5l1.1-2.8l-2.3-5.7h1.5l1.4,3.9l1.4-3.9h1.5L71.4,26.6z M65.8,24.2c-0.5,0-1-0.2-1.5-0.6V24h-1.5
	...
	C17.1,17.7,16.5,17.2,15.6,17.2z"
      ...
      <path
        class="st1"
        d="M136.8,21.9h-7.2c0.2,1.7,1.4,2.2,2.9,2.2c1.5,0,2.6-0.3,3.6-0.8v3c-1,0.6-2.3,1-4.1,1c-3.6,0-6.1-2.3-6.1-6.7
